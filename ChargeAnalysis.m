function [charge,bdryPairs]=ChargeAnalysis(cv,cvdata,sensingVoltage,varargin)
% cv has background substracted voltammograms as columns
...
%%%  -------- code above optional --------%%%
for i=1:injections
    charge(1,i)=0.001*trapz(cv(bdry(1,i):bdry(2,i),i));
    charge(2,i)=0.001*trapz(cv(bdry2(1,i):bdry2(2,i),i));
    charge(3,i)=0.001*trapz(cv(bdry3(1,i):bdry3(2,i),i));
end
